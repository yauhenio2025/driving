...
- **Entry Points**:
  ...
  - `src/lib/gemini.js:58-101` - Gemini 3.1 Flash Lite API with Google Search grounding and caching
...
- **Dependencies**: Gemini API key (3.1 Flash Lite for text, 3.1 Flash Image for diagrams), trafficLaw.js
- **Added**: 2026-03-07 | **Modified**: 2026-03-09
